...
inputFile=[0 for i in range(7)]
inputFile[1]  = "HVSCAN/002398/HV9/HV9.dqm.root"
inputFile[1]  = "HVSCAN/ecogasboth2/run1/run1.root"
inputFile[2]  = "HVSCAN/ecogasboth/run2/run2.root"
inputFile[3]  = "HVSCAN/ecogasboth/run3/run3.root"
inputFile[4]  = "HVSCAN/ecogasboth/run4/run4.root"
inputFile[5]  = "HVSCAN/ecogasboth/run5/run5.root"
inputFile[6]  = "HVSCAN/ecogasboth/run6/run6.root"
